...
#단국대 주변, 식당 리스트
restaurant_all = ["학식", "옹고집", "김치짜글이", "손가네", "한솥", "꾸이한끼", "칼제비", "맛의 전쟁", "꾸이한끼", "해피덮", "알촌",
                   "홍춘", "홍콩반점", "중국식당(2층)", "천향", "스부",
                   "겐코", "호식당", "우메다", "아리가또", "역전우동",
                   "일미", "브라더 양식당", "맘스터치",
                   "베트남 노상", "도스마스", "인도네팔", "투고박스"]
restaurant_korean = ["학식", "옹고집", "김치짜글이", "손가네", "한솥", "꾸이한끼", "칼제비", "맛의 전쟁", "해피덮", "알촌"]
restaurant_china = ["홍춘", "홍콩반점", "중국식당(2층)", "천향", "스부"]
restaurant_japan = ["겐코", "호식당", "우메다", "아리가또", "역전우동"]
restaurant_western = ["겐코", "호식당", "우메다", "아리가또", "역전우동"]
